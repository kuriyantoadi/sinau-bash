...
## Soal nomor 42
  echo "42. Untuk melihat Calender pada Linux ?"
  echo -n "   Jawaban : "
  read jwb42
...
## Soal nomor 45
  echo "45. Perlukah untuk Directory/file diberikan Hak akses? benar/salah "
  echo -n "   Jawaban : "
  read jwb45
...
## Soal nomor 46
  echo "46. Berikut Perintah ini *chmod 788 belajar-bash.sh* ? benar/salah"
  echo -n "   Jawaban : "
  read jwb46
...
## Soal nomor 49
  echo "49. Apakah Nano atau vim termasuk suatu perintah Pada Linux benar/salah?"
  echo -n "   Jawaban : "
  read jwb49
